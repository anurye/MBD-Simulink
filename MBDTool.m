classdef MBDTool < matlab.apps.AppBase
    ...
    properties (Access = public)
        ...
        action_dropdown         matlab.ui.control.DropDown
        submit_button           matlab.ui.control.Button
    ...
    methods (Access = public)
        ...
        function app = MBDTool
            ...
            app.ui_figure = uifigure('Name', 'MBD Tool', ...
                ...
                'Resize', 'off', 'WindowStyle', 'alwaysontop');
            ...
            app.input_suffix_field = uieditfield(app.button_group_panel, 'text', ...
                ...
                'Position', [10, 40, 120, 30]);

            % Submit suffix button
            app.action_dropdown = uidropdown(app.button_group_panel, ...
                'Items', {'Append', 'Remove'}, ...
                'Position', [160, 40, 60, 30]);
            app.submit_button = uibutton(app.button_group_panel, ...
                    'Text', 'Submit', ...
                    'Position', [230, 40, 50, 30], ...
